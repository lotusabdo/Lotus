...
async def abrag(c: Client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("القوس", callback_data="elqoos " + str(m.from_user.id))],
         [InlineKeyboardButton(" ●○ᏞΌͲႮՏ○●", url=f"https://t.me/l2_2Y")],
...
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
•︙مهنياً :  يرّوج بعض الزملاء الإشاعات عن وضعك، لكنّك تبقى صلباً وتحديداً في المركز المهم الذي أسنده إليك أرباب العم
InlineKeyboardButton("ՏΌႮᎡᏟᎬ ᏞΌͲႮՏ", url=f"https://t.me/l2_2Y")],
    await m.message.reply_text(abrag_text, reply_to_message_id=mid)
